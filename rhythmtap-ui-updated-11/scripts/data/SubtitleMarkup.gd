...
const TAGS := {
	"whisper": "[font_size=16][i][color=#d8d8e6][outline_size=3][outline_color=#101018]",
	...
	"drain": "[i][color=#d4b4ff][outline_size=3][outline_color=#1a1028]",
	"hot": "[color=#ff7a3d][pulse freq=1.15 color=#ffd0a8]",
	"cold": "[color=#b8f0ff][outline_size=2][outline_color=#082028]",
	...
	"echo": "[color=#d8d8ff][outline_size=4][outline_color=#181830]",
	...
	"velvet": "[i][color=#e0c8ff][outline_size=2][outline_color=#181028]",
...
const CLOSE_EXTRAS := {
	"whisper": "[/outline_color][/outline_size][/color][/i][/font_size]",
	"shout": "[/shake][/color][/b][/font_size]",
	"moan": "[/wave][/color][/i]",
	"tease": "[/wave][/color][/i]",
	"command": "[/outline_color][/outline_size][/color][/b]",
	"drain": "[/outline_color][/outline_size][/color][/i]",
	"hot": "[/pulse][/color]",
	"cold": "[/outline_color][/outline_size][/color]",
	"sweet": "[/color][/i]",
	...
	"growl": "[/shake][/color][/b]",
	"heart": "[/pulse][/color]",
	"echo": "[/outline_color][/outline_size][/color]",
	...
	"punk": "[/shake][/color][/b]",
	"hyper": "[/pulse][/color][/b]",
	"velvet": "[/outline_color][/outline_size][/color][/i]",
